...
# Controleer of de OAuth-gegevens al zijn ingesteld in session_state
...
st.session_state.client_id = st.text_input('Client ID', st.session_state.client_id, type="password")
st.session_state.client_secret = st.text_input('Client Secret', st.session_state.client_secret, type="password")
st.session_state.tenant_id = st.text_input('Tenant ID', st.session_state.tenant_id)
...
# Functie om de gegevens op te halen en terug te laden
def execute_actions():
    # Verkrijg het access token
    access_token = get_access_token(st.session_state.client_id, st.session_state.client_secret, st.session_state.tenant_id)
...
# Wanneer de knop wordt ingedrukt, voer de actie uit
if st.button('Verbinding maken en gegevens ophalen'):
    if not st.session_state.client_id or not st.session_state.client_secret or not st.session_state.tenant_id:
